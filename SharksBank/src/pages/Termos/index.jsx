        ...
        >
          <div id={styles["container-termos"]}>
            <div id={styles["div-texto-termos"]} onScroll={handleScroll}>
              ...
              <br />
              <p>
                Bem-vindo ao Sharks Bank! Agradecemos por escolher nossos
                serviços financeiros. Ao utilizar nossos serviços, você concorda
                com os termos e condições descritos abaixo:
                <br />
                <br />
                <strong>Definições</strong> <br />
                <br />
                1.1. "Sharks Bank", "nós", "nosso" se refere à fintech Sharks
                Bank e todas as suas empresas subsidiárias. <br />
                ...
                <br />
                2.1. Para utilizar os serviços do Sharks Bank, o usuário deve
                ter pelo menos 18 anos de idade e possuir capacidade legal para
                celebrar contratos.
                <br />
                ...
                <br />
                <br />
                4.1. O usuário concorda em utilizar os serviços do Sharks Bank
                de forma legal e ética.
                <br />
                4.2. O usuário concorda em não utilizar os serviços do Sharks
                Bank para atividades ilegais ou fraudulentas.
                <br />
                ...
                <br />
                <br />
                5.1. O usuário concorda em pagar as taxas associadas aos
                serviços do Sharks Bank.
                <br />
                ...
                <br />
                6.2. O usuário concorda em compartilhar informações pessoais com
                o Sharks Bank para utilização dos serviços.
                <br />
                ...
                diretos ou indiretos causados ao usuário pelo uso dos serviços
                do Sharks Bank.
                <br />
                ...
                <br />
                <br />
                8.1. Estes termos e condições representam o acordo integral
                entre o usuário e o Sharks Bank em relação aos serviços.
                <br />
                ...
                Internacional (CCI).
                <br />
                8.4. O usuário concorda em isentar o Sharks Bank, seus
                diretores, funcionários, afiliados e agentes de qualquer
                responsabilidade por quaisquer reivindicações, ações, perdas ou
                danos decorrentes do uso dos serviços do Sharks Bank.
                <br />
                ...
                condições só terá efeito se for feita por escrito e assinada
                pelo Sharks Bank.
                <br />
                ...
                <br />
                9.1. O usuário concorda em receber comunicações do Sharks Bank
                por e-mail, SMS, notificações push ou qualquer outro meio de
                ...
                resolvida por meio de arbitragem, em conformidade com as regras
                de arbitragem da Câmara de Comércio Internacional (CCI), sediada
                em São Paulo, Brasil. <br />
                11.3. As partes concordam em submeter-se à jurisdição exclusiva
                dos tribunais de São Paulo, Brasil, para qualquer disputa que
                não possa ser resolvida por meio de arbitragem. <br />
                <br />
