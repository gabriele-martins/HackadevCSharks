    ...
    <>
      ...
      <div className={styles.conteudoSaldo}>
          <div className={styles.painelNomes}>
            <h1>Olá, Tubarão</h1> <div>Ultimo Acesso: 15/04/2023 - 00:00</div>
          </div>
          <div className={styles.painelSuperior}>
              ...
              <div className={styles.blocoConteudo}>
                <div className={styles.blocoConteudoLinha}>
                  ...
                  <div className={styles.blocoConteudoLinhaValue}>R$ 100</div>
                </div>
                <div className={styles.blocoConteudoLinha}>
              ...
              <div className={styles.blocoConteudo}>
                <div className={styles.blocoConteudoLinha}>
                  ...
                  <div className={styles.blocoConteudoLinhaItem}>Limite Disponível:&nbsp;</div>
                  <div className={styles.blocoConteudoLinhaValue}>R$ 10</div>
                </div>
                <div className={styles.blocoConteudoLinha}>
                  <div className={styles.blocoConteudoLinhaIcone}><Receipt size={32} color="#00efc5"/></div>
                  <div className={styles.blocoConteudoLinhaItem}>Saldo fatura:&nbsp;</div>
                  <div className={styles.blocoConteudoLinhaValue}>R$ 2</div>
                </div>
              </div>
